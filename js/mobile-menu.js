document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".i-v-navigation-list");
  const headerRef = document.querySelector(".i-v-header");
  const navigationRef = document.querySelector(".i-v-navigation");
  ...
  document.querySelectorAll(".i-v-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".i-v-toggle-button img");
